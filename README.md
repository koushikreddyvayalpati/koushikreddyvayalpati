...
My work sits between AI engineering, backend systems, infrastructure, full-stack product work, and enterprise workflows. I am focused on the kind of engineering needed for real agent orchestration: tool routing, memory, state, evaluation, fallback paths, scaling, and reliable execution.
